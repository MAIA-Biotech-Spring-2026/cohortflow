...
export default function ApplicantError({
  ...
  useEffect(() => {
    console.error("Applicant portal error:", error);
  }, [error]);
    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="mx-auto max-w-md text-center">
        ...
        <h1 className="mb-2 text-2xl font-bold text-gray-900">
          Applicant Portal Error
        </h1>
        <p className="mb-6 text-gray-600">
          We encountered an error in the applicant portal. Please try again or return to
          your dashboard.
        </p>
        {error.digest && (
        ...
        <div className="flex gap-3 justify-center">
          ...
          <Link
            ...
            aria-label="Return to applicant dashboard"
          >
